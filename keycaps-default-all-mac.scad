...
keycaps = [
    ...
    keycap(2, 1, center_svg = "KC_X",    left_svg = "KC_F1",    right_svg = "KC_BSLS",  side_svg = "KC_MCTL"),
    keycap(2, 2, center_svg = "KC_C",    left_svg = "KC_F2",    right_svg = "KC_COMM",  side_svg = "KC_MOPT"),
    keycap(2, 3, center_svg = "KC_V",    left_svg = "KC_F3",    right_svg = "KC_DOT",   side_svg = "KC_MCMD"),
    keycap(2, 4, center_svg = "KC_B",    left_svg = "KC_F11",                           side_svg = "KC_MFN"),
    ...
    keycap(2, 5, center_svg = "KC_N",    left_svg = "KC_DEL",   right_svg = "MS_BTN1",  side_svg = "KC_MFN"),
    keycap(2, 6, center_svg = "KC_M",    left_svg = "KC_TAB",   right_svg = "KC_1",     side_svg = "KC_MCMD"),
    keycap(2, 7, center_svg = "KC_COMM",                        right_svg = "KC_2",     side_svg = "KC_MOPT"),
    keycap(2, 8, center_svg = "KC_DOT",                         right_svg = "KC_3",     side_svg = "KC_MCTL"),
